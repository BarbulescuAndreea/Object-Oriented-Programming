...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("testing teacher for programming_paradigms");
        System.out.println(testTeacher.getTeachersBySubject(PROGRAMMING_PARADIGMS));
        System.out.println("testing teacher for data_Structures");
        ...
        System.out.println(testTeacher.getAllStudents());
        System.out.println("testing student for programming_paradigms");
        System.out.println(testTeacher.getStudentsBySubject(PROGRAMMING_PARADIGMS));
        System.out.println("testing getStudentsByAverageGrade");
        System.out.println(testTeacher.getStudentsByAverageGrade());
        System.out.println("testing getStudentsByGradeForSubject");
        System.out.println(testTeacher.getStudentsByGradeForSubject(PROGRAMMING_PARADIGMS));
        System.out.println("testing teacher for computers_programming");
        ...
        System.out.println("testinging immutability for students");
        ...
        System.out.println("Testing getStudentsByGradeForSubject for programming_paradims");
        System.out.println(testStudent.getStudentsByGradeForSubject(PROGRAMMING_PARADIGMS));
        System.out.println("Testing getStudentsByGradeForSubject for operating_systems");
        System.out.println(testStudent.getStudentsByGradeForSubject(OPERATING_SYSTEMS));
        System.out.println("Testing getStudentsByGradeForSubject for communication_protocols");
